                                        ...
                                        if player_data.status == 200:
                                            ...
                                            if len(pdata) < 1:
                                                ...
                                                for index in list(api_data.copy()):
                                                    if index not in league_fields:
                                                        del api_data[index]

                                                for index in list(api_data.copy()):
                                                    for field in list(api_data[index].copy()):
                                                        if 'appearances' not in api_data[index][field] or api_data[index][field]['appearances'] == 0 or api_data[index][field]['appearances'] == '0':
                                                            del api_data[index][field]
                                                        if field == '0':
                                                            del api_data[index][field]
                                                        
                                                    # else:       
                                                    #     for element in api_data.copy():
                                                    #         if 'appearances' not in api_data[index][element] or api_data[index][element]['appearances'] == 0 or api_data[index][element]['appearances'] == '0':
                                                    #             del api_data[index][element]
                                                # league_stats = copy.copy(api_data)

                                                # for index in league_data.keys():
                                                #     for field in league_data[index]:
                                                #         if field == '0':
                                                #             del api_data[index]
                                                #         if 'appearances' not in league_stats[index][field] or league_stats[index][field]['appearances'] == 0 or league_stats[index][field]['appearances'] == '0':
                                                #             del api_data[index][field]
